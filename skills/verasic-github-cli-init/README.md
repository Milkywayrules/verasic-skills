...
live under `.cursor/skills/verasic-github-cli-init/`.
...
| `.cursor/rules/verasic-github-cli-env.mdc` | Always-applied digest for `gh` commands (after `setup.sh`) |
...
Or in Cursor: `/verasic-github-cli-init`
...
4. `bash .cursor/skills/verasic-github-cli-init/scripts/check-gh.sh`
...
- `/verasic-github-cli-init` — bootstrap current repo
- Regression: `bash .cursor/skills/verasic-github-cli-init/scripts/test-regression.sh`
