...
4. List every `.md` file in `.cursor/skills/verasic-bugbot/checklists/` and apply ALL of them — projects may add custom checklists beyond correctness/security/performance.
